...
kernelSmoothing <-
  ...
  )
  {
    ...
    { 
      ...
      cat("fin calcul indices:", Sys.time() - debut, "\n")
      debut <- Sys.time()
      ...
      cat("fin creation dfCentroids:", Sys.time() - debut, "\n")
      debut <- Sys.time()
      ...
      cat("fin creation mIndicesEtendus:", Sys.time() - debut, "\n")
      debut <- Sys.time()
      ...
      cat("fin decalage mIndicesEtendus:", Sys.time() - debut, "\n")
      debut <- Sys.time()
      ...
      cat("fin dtCentroidesUniques:", Sys.time() - debut, "\n")
      debut <- Sys.time()
    ...
    if (is.null(vQuantiles))
    {
      ...
      cat("fin mIcentroides:", Sys.time() - debut, "\n")
      debut <- Sys.time()
